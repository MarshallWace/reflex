...
impl From<Append> for Stdlib {
    fn from(_value: Append) -> Self {
        Self::Append
    }
}
...
impl From<Collect> for Stdlib {
    fn from(_value: Collect) -> Self {
        Self::Collect
    }
}
impl From<CollectFilterResults> for Stdlib {
    fn from(_value: CollectFilterResults) -> Self {
        Self::CollectFilterResults
    }
}
...
impl From<CollectRecord> for Stdlib {
    fn from(_value: CollectRecord) -> Self {
        Self::CollectRecord
    }
}
...
impl From<Entries> for Stdlib {
    fn from(_value: Entries) -> Self {
        Self::Entries
    }
}
