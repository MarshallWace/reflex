...
mod tests {
    ...
    fn addition_expressions() {
        let env = Env::new();
        let expression = Node::parse("(add 0 0)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Value(ValueNode::Int(0 + 0))))
        );
        let expression = Node::parse("(add 3 4)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
        ...
        let expression = Node::parse("(add 0.0 0.0)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Value(ValueNode::Float(0.0 + 0.0))))
        );
        let expression = Node::parse("(add 2.718 3.142)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
    ...
    fn invalid_addition_expression_operands() {
        let env = Env::new();
        let expression = Node::parse("(add 3 3.142)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
        ...
        let expression = Node::parse("(add 3.142 3)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add 3 null)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add 3 false)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add 3 \"3\")").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add null 3)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add false 3)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add 3.142 null)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add 3.142 false)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add null 3.142)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(add false 3.142)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
