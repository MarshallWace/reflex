...
impl AstNode<Node> for EqualNode {
...
impl<'a> CompoundNode<'a, Node> for EqualNode {
...
impl NodeType<Node> for EqualNode {
    fn hash(&self) -> u32 {
...
impl fmt::Display for EqualNode {
