...
impl<'a> CompoundNode<'a, Node> for LtNode {
...
mod tests {
    ...
    #[test]
    fn invalid_lt_expression_operands() {
        let env = Env::new();
        let state = RuntimeState::new();
