...
impl SubtractNode {
    ...
    pub fn factory(args: &Vec<Expression<Node>>) -> Result<Self, String> {
        ...
        Ok(SubtractNode::new(left, right))
    }
}
...
mod tests {
    ...
    fn subtraction_expressions() {
        let env = Env::new();
        let expression = Node::parse("(subtract 0 0)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Value(ValueNode::Int(0 - 0))))
        );
        let expression = Node::parse("(subtract 3 4)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
        ...
        let expression = Node::parse("(subtract 0.0 0.0)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Value(ValueNode::Float(0.0 - 0.0))))
        );
        let expression = Node::parse("(subtract 2.718 3.142)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
    ...
    fn invalid_subtraction_expression_operands() {
        let env = Env::new();
        let expression = Node::parse("(subtract 3 3.142)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
        ...
        let expression = Node::parse("(subtract 3.142 3)").unwrap();
        let result = expression.evaluate(&env);
        ...
        let expression = Node::parse("(subtract 3 null)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(subtract 3 false)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(subtract 3 \"3\")").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(subtract null 3)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(subtract false 3)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(subtract 3.142 null)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(subtract 3.142 false)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(subtract null 3.142)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
        ...
        let expression = Node::parse("(subtract false 3.142)").unwrap();
        let result = expression.evaluate(&env);
        assert_eq!(
            result,
            Expression::new(Node::Core(CoreNode::Error(ErrorNode::new(
