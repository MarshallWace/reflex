...
impl<'a> CompoundNode<'a, Node> for LteNode {
...
impl NodeType<Node> for LteNode {
    fn hash(&self) -> u32 {
...
mod tests {
    ...
    #[test]
    fn invalid_lte_expression_operands() {
        let env = Env::new();
        let state = RuntimeState::new();
